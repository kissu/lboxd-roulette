...
.back {
  ...
  opacity: 0.8;
  background-image: linear-gradient(135deg, #0d0d0e 25%, transparent 25%),
    linear-gradient(225deg, #0d0d0e 25%, transparent 25%),
    linear-gradient(45deg, #0d0d0e 25%, transparent 25%),
    linear-gradient(315deg, #0d0d0e 25%, #000000 25%);
